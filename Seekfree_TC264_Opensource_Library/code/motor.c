...
void updateMotors(
    ...
    */
    ...
    angPIDy.target = 0.5f + (float)(-velPIDy.deltaOutput                      ) / 100; angPIDy.measurement = pitchY; __updatePID(&angPIDy);
    angPIDz.target = 0.0f ;                                                            angPIDz.measurement = 0; __updatePID(&angPIDz);
